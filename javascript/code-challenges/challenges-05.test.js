...
const toLastNames = people => {
  // Solution code here...
  let myArr = people.map((name) => name.firstName +' '+ name.lastName);
  return myArr;
};
...
const addValues = (arr) => {
  // Solution code here...
  let myArr = arr.reduce((a, b) => a + b, 0);
  return myArr;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const addPurchases = (arr) => {
  // Solution code here...
  let myArr = arr.reduce((a, b) => a + b.purchasePrice, 0);
  return myArr;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let myArr =[];
  let arrEle = arr.reduce((a, b) => myArr.push(b.name), 0);
  console.log(arrEle);
  return myArr;
};
/* ------------------------------------------------------------------------------------------------
